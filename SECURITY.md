...
- The isolated DSH installation contacts only the configured HTTPS npm registry. General dependency lifecycle scripts stay disabled; the Action explicitly rebuilds only DSH's required `node-pty` native module.
